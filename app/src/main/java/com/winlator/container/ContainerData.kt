...
data class ContainerData(
    ...
    val applyColorCorrection: Boolean = true,
        ...
        val Saver = mapSaver(
            save = { state ->
                mapOf(
                    ...
                    "applyColorCorrection" to state.applyColorCorrection,
            ...
            restore = { savedMap ->
                ContainerData(
                    ...
                    applyColorCorrection = (savedMap["applyColorCorrection"] as? Boolean) ?: true,
