...
// live-previews locally; commits to container JSON only on Done.
@Composable
...
// local copy of XServerScreen's private EditModeToolbar, so the Wine side stays untouched. Done saves.
@Composable
