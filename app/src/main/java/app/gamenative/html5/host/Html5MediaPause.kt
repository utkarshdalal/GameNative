...
// WebView.onPause() stops JS timers and compositing but leaves <audio>/<video> and AudioContexts playing.
// paused state is recorded on window so resume restores exactly what WE paused, not what the game paused.
