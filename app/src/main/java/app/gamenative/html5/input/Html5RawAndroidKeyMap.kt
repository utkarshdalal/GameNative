...
// fallback only for a profile with no controller for the device. normally the wildcard "*"
// controller from Html5DefaultControlsProfileFactory handles every keycode.
