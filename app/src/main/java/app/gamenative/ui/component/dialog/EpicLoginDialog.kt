...
/**
 * Epic Login Dialog – in-app WebView only (automatic code capture).
 * Same pattern as GOG: no browser or manual paste flow.
 */
@Composable
fun EpicLoginDialog(
    visible: Boolean,
    ...
    AlertDialog(
        ...
        confirmButton = {
            Button(
                ...
                Text(stringResource(R.string.epic_login_in_app_button))
            }
        },
        dismissButton = {
            TextButton(
