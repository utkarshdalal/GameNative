    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        when (postSyncInfo.syncResult) {
            SyncResult.Conflict -> {
                ...
                val (conflictTitle, conflictMessage) = when {
                    postSyncInfo.recoveredLocalAheadConflict -> {
                    ...
                    postSyncInfo.conflictUfsVersion != null -> {
                        val version = postSyncInfo.conflictUfsVersion
                        val titleId = context.resources.getIdentifier(
                            "main_save_conflict_upgrade_v${version}_title", "string", context.packageName,
                        )
                        val msgId = context.resources.getIdentifier(
                            "main_save_conflict_upgrade_v${version}_message", "string", context.packageName,
                        )
