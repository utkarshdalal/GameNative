 ...
 * Steam icon is built from the provided SVG path data and will be tinted by Icon() like Material icons.
 */
val Icons.Filled.Steam: ImageVector
    get() {
        ...
        _steam = ImageVector.Builder(
            ...
            // Path from provided SVG; fill set to black so Icon tint will color it
            addPath(
...
val Icons.Filled.OpenContainer: ImageVector
