...
// only the keys not derivable from process.env live here (productName, appPath, version);
// userData/appData/temp/etc. are derived JS-side in packs/electron.js from the process.env
// Windows-NWjs posture set up by IndexHtmlRewriter.
