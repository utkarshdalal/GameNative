...
class WebViewLocaleResolverTest {
    ...
    // english is intentionally missing -- it's the "unset" sentinel and must return null.
    ...
    // (a) falls through for "english" (sentinel).
    @Test
    ...
    // (a) falls through for unknown goldberg -- MUST NOT fail launch.
    @Test
    ...
    // (c) "und" skipped -> (d) final fallback.
    @Test
    ...
    // (a) case-insensitive goldberg + empty app lang.
    @Test
