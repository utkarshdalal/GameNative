...
// robolectric needed because TouchGestureConfig.toJson uses org.json.JSONObject.
...
class IndexHtmlRewriterOverscrollTest {
    ...
    @Test fun gestureConfigJson_real_data_class_json_round_trips_unchanged() {
        // TouchGestureConfig().toJson() is the exact form WebViewScreen passes; it must appear
        // verbatim (no escaping breakage).
