...
// EXECUTES require-dispatcher.js under Rhino and asserts the real dispatch order (exact >
// pattern > originalRequire > miss) -- logic regressions the source-grep
// RequireDispatcherPatternTest can't catch.
