...
// pure-jvm -- @JavascriptInterface is metadata-only on the jvm classpath and GamepadState is plain
// java, no android <clinit>.
class Html5GamepadBridgeTest {
    ...
    fun trigger_L_surfaces_only_in_buttons_6() {
        ...
        // standard mapping: triggers MUST NOT contaminate axes (reading axes[2]=triggerL as RX
        // left the right stick's LR dead).
    ...
    fun thumb_RX_RY_emit_to_axes_2_3_per_w3c_standard() {
        // [LX, LY, RX, RY] is what standard-aware engines expect; thumbRX at axes[3] was read as RY.
        val bridge = Html5GamepadBridge()
