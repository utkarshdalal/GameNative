...
// chromium's File System/Origins index maps "ORIGIN:<scheme_host_port>" -> bucket dir name. it drives the
// OPFS wipe on uninstall; a wrong/missing read leaks stale OPFS saves across a reinstall.
