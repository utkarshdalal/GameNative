 ...
 * This gate controls runtime defaults for autoTuningMode, adaptiveFpsCapEnabled,
 * enablePerClusterTuning, gamePinningMode (Auto vs Off), and enableFanControl in PServerDriver.getDefaultProfile().
 */
